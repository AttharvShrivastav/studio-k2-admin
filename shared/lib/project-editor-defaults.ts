...
export function createTemplateConfig(template: TemplateType): TemplateConfig {
  ...
  return { template, sections: { intro: intro(), horizontalStory: { enabled: false, content: { accentColor: "", textColor: "", frames: [], gallery: null } }, narrative: { enabled: false, headingLines: [], bodyCopy: "", images: [] }, drawing: drawingTwelve() }};
}
