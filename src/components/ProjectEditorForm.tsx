...
function TemplateContent({ template }: { template: TemplateType }) {
  ...
  const sectionNames = template === "template-1" ? ["Statement", "Story", "Custom Scroll Sequence", "Feature", "Horizontal Story", "Drawing"] : template === "template-2" ? ["Intro", "Horizontal Story", "Narrative", "Drawing"] : template === "template-3" ? ["Intro", "Scroll Sequence", "Horizontal Story", "Drawing"] : ["Intro", "Horizontal Story", "Narrative", "Drawing"];
