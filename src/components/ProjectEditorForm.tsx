...
function AnimatedHeadingComposer({ paths, title = "Animated heading" }: { paths: { line1: string; line2First: string; line2Second: string; line3: string; line4First: string; line4Second: string }; title?: string }) {
  return <fieldset className="heading-composer"><legend>{title}</legend><Field label="Line 1" name={paths.line1} /><div className="heading-line-group"><p className="heading-line-label">Line 2</p><div className="phrase-row"><Field label="First phrase" name={paths.line2First} /><Field label="Second phrase" name={paths.line2Second} /></div><p className="field-hint phrase-hint">Both phrases appear together on the same animated line.</p></div><Field label="Line 3" name={paths.line3} description="This line will shift right in the project animation." /><div className="heading-line-group"><p className="heading-line-label">Line 4</p><div className="phrase-row"><Field label="First phrase" name={paths.line4First} /><Field label="Second phrase" name={paths.line4Second} /></div><p className="field-hint phrase-hint">Both phrases appear together on the same animated line. This line will shift right.</p></div></fieldset>;
}
