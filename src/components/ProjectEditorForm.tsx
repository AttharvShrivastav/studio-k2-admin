...
function LineEditor({ label, name, fixedCount, max = 8 }: { label: string; name: string; fixedCount?: number; max?: number }) {
...
function GalleryEditor() {
  ...
  return <>
    ...
    <LineEditor label="Gallery title" name="galleryConfig.titleLines" fixedCount={2} />
